...
public class EightPuzzleState extends SearchState {
  ...
  // Will work out the number of elements that don't match the target state for hamming distance
  public int estRemCost(Search searcher){
    EightPuzzleSearch eightSearch = (EightPuzzleSearch) searcher;
    int[][] targetState=eightSearch.getTarget();
    int eRemCost=0;
    for(int i=0;i<=2;i++){
  ...
  // Will compute manhattan distance!
